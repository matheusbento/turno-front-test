...
describe("Add Item component", () => {
  ...
  it("should display an icon.", () => {
    ...
    expect(
      container.querySelector('[data-src="/images/icon-plus-line.svg"]')
    ).toBeTruthy();
  });

  it("should display a label.", () => {
    const { queryByText } = render(
      <AddItem label="Text Example" addHandler={mockedAddHandler} />
    );
  ...
  it("should pass class to container element.", () => {
    ...
    expect(containerElement?.className).toEqual(
